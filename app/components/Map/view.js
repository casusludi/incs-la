...
export function view({
    ...
    const fastAccessButtonsVdom$ = fastAccessButtons$.compose(mixCombine('DOM'));
    ...
    const vdom$ = xs.combine(
        ...
        <div className={"travel-panel" + (showMap ? " expanded" : "")}>
            <button className={`travel-panel-button-open glue-button glue-button-right js-show-map ${buzz ? 'buzz' : ''}`} type="button" ><i className="svg-icon icon-map" /></button>
